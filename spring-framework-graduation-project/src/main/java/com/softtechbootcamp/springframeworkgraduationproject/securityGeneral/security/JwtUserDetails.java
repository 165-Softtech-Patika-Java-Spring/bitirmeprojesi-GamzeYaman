...
public class JwtUserDetails implements UserDetails {
    ...
    //başkası constructor oluşturmasın, singletion
    ...
    public static JwtUserDetails create(UsUser usUser){

        Long id = usUser.getId();
        String username = usUser.getUsername();
        String password = usUser.getUserPassword();
